...
def main():
	...
	reqArgs.add_argument('-o', '--outName',  help='Name for output file with designed primers', required=True)
	...
	parser.add_argument('--structureThresh', default=45, type=float, help='Maximum threshold for hairpin and homodimer Tm.')
	...
	fout.write("Name\tLength\tCoreLength\tClampLength\tDegeneracy\tDirection\tStart\tEnd\tAvgHairpinTm\tMinHairpinTm\tMaxHairpinTm\tAvgHomoDimTm\tMinHomoDimTm\tMaxHomoDimTm\tSequence\tRevComp\tAvgTm\tMinTm\tMaxTm\tAvgCoreMis\tMinCoreMis\tMaxCoreMis\tAvgClampMis\tMinClampMis\tMaxClampMis\n")

	# Open log file for writing and add header
	flog = open(args.log, "w")
	flog.write("Name\tPropCoreMatch\tMaxClampLength\tClampsConsidered\tClampsMeetGC\tClampsMeetTm\tClampsMeetHairpin\tClampsMeetHomodimer\n")
